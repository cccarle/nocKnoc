...
class SpinKitRing1 extends StatefulWidget {
  ...
  @override
  _SpinKitRing1State createState() => _SpinKitRing1State();
}

class _SpinKitRing1State extends State<SpinKitRing1>
  ...
  void initState() {
    ...
    _animation1 = Tween(begin: 0.0, end: 0.0).animate(
      CurvedAnimation(
        parent: _controller,
    ...
    _animation2 = Tween(begin: -1.5 / 3, end: 2 / 2).animate(
      CurvedAnimation(
        parent: _controller,
    ...
    _animation3 = Tween(begin: 0.0, end: 6 / 6).animate(
      CurvedAnimation(
        parent: _controller,
  ...
  Widget build(BuildContext context) {
    final Matrix4 transform = Matrix4.identity()
      ..rotateZ((_animation1.value) * 6 * pi / 6);
    return Center(
      child: Transform(
        transform: transform,
